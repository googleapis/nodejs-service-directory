...
describe('v1.RegistrationServiceClient', () => {
    ...
    describe('createNamespace', () => {
        it('invokes createNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateNamespaceRequest', ['parent']);
    ...
    describe('getNamespace', () => {
        it('invokes getNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNamespaceRequest', ['name']);
    ...
    describe('updateNamespace', () => {
        it('invokes updateNamespace without error', async () => {
            ...
            request.namespace ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateNamespaceRequest', ['namespace', 'name']);
    ...
    describe('deleteNamespace', () => {
        it('invokes deleteNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNamespaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateEndpointRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getEndpoint', () => {
        it('invokes getEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.servicedirectory.v1.Endpoint()
    ...
    describe('updateEndpoint', () => {
        it('invokes updateEndpoint without error', async () => {
            ...
            request.endpoint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateEndpointRequest', ['endpoint', 'name']);
    ...
    describe('deleteEndpoint', () => {
        it('invokes deleteEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
