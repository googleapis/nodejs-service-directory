...
describe('v1.RegistrationServiceClient', () => {
    ...
    describe('createNamespace', () => {
        it('invokes createNamespace without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.Namespace());
    ...
    describe('updateNamespace', () => {
        it('invokes updateNamespace without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.UpdateNamespaceRequest());
            request.namespace = {};
    ...
    describe('deleteNamespace', () => {
        it('invokes deleteNamespace without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.DeleteNamespaceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createService', () => {
        it('invokes createService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.CreateServiceRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.Service());
    ...
    describe('getService', () => {
        it('invokes getService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.GetServiceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateService', () => {
        it('invokes updateService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.UpdateServiceRequest());
            request.service = {};
    ...
    describe('deleteService', () => {
        it('invokes deleteService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.DeleteServiceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.CreateEndpointRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.Endpoint());
    ...
    describe('getEndpoint', () => {
        it('invokes getEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.GetEndpointRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listNamespaces', () => {
        it('invokes listNamespaces without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.ListNamespacesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listServices', () => {
        it('invokes listServices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.ListServicesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.servicedirectory.v1.ListEndpointsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
