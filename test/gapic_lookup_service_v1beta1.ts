...
describe('v1beta1.LookupServiceClient', () => {
    ...
    describe('resolveService', () => {
        it('invokes resolveService without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.servicedirectory.v1beta1.ResolveServiceResponse());
            ...
            assert((client.innerApiCalls.resolveService as SinonStub)
        ...
        it('invokes resolveService with error', async () => {
            ...
            await assert.rejects(async () => { await client.resolveService(request); }, expectedError);
            assert((client.innerApiCalls.resolveService as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
